...
public class C01_TreeMap {
    public static void main(String[] args) {
        ...
        // Data türü olarak Map seçersek
        // biz bir TreeMap oluştursak da tüm Map'lerle ortak olan özellikleri verir
        ...
        System.out.println(harfler); // bu method TreeMap'de kalıcı değişiklik YAPAMAZ

        //  harfler = harfler.descendingMap();  TreeMap doğal sıralı olacağından,
        //                                      descending sıralamayı kabul etmez
        ...
        // Lower girilen key'den küçük olan en büyük key'i verir
        // floor matematikdeki aşağı yuvarla gibidir
        // verilen key veya key yoksa ondan küçük olan en büyük key'i verir
