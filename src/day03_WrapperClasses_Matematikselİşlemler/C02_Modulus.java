...
public class C02_Modulus {
    public static void main(String[] args) {
        ...
        System.out.println(283 % 10 );  // birler basamagını yazdıralım

        System.out.println(283 % 2);   // 283 tek mi cift mi ?  1==> tek sayıdır

        System.out.println(347 % 5 );  // 347 sayısı 5 ile tam bolunur mu ? 2==> tm bolunmez

        System.out.println(85 / 6 );  // 14,.... ==> 14
