...
public class C02_Varargs {
    public static void main(String[] args) {
        ...
        /*
             method call sırasında istediğim kadar argument yazabilmek istiyorum

             java variety of arguments ==> varargs ile hizmetinizde

             varargs array alt yapısını kullanarak
             istediğimiz kadar argument yazmamıza imkan tanır
        */
