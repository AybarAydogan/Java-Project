...
public class C02_NestedMapOlusturma {
    ...
    private static Map<Integer, Map<String, String>> ogrenciEkle(Map<Integer, Map<String, String>> ogrenciMap, int ogrNo, String isim, String soyisim, String sınıf, String sube, String bolum) {

        Map<String , String > ogrMap = new HashMap<>();
        ogrMap.put("isim",isim);
        ogrMap.put("soyisim",soyisim);
        ogrMap.put("sinif",sınıf);
