...
public class M_GrandChild extends K_Child{
    ...
    public void runnerMethod(){
        ...
        System.out.println(super.isim); // Aybar
        System.out.println(super.memleket); // Van

        System.out.println(sansliSayi); // 15
        // System.out.println(this.sansliSayi); //
        // System.out.println(super.sansliSayi);

        System.out.println(arkadas); // Tarık
        System.out.println(this.arkadas); // Tarık
